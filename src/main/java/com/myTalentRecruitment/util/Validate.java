...
public abstract class Validate {
	...
	private static final String PATTERN_OBSERVATIONS = "[A-ZÁÉÍÓÚáéíóúa-z]{0,1}[A-ZÁÉÍÓÚáéíóúa-z-' ']{0,149}";
	private static final String PATTERN_WORKER_EMAIL = "[a-z0-9._%+-]+@getronics.com";
